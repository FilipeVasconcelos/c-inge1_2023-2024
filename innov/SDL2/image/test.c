...
#define TN_FLAG_IMAGE_PATH "assets/labrador.jpg"
...
int main(int argc, char* argv[])
{
    ...
    int flags = IMG_INIT_JPG; // Can be: IMG_INIT_JPG | IMG_INIT_PNG
    ...
    else
    {
        ...
        else
        {
            ...
            if(w > h) {
                flagRect.w = SCREEN_WIDTH * 0.3;
                flagRect.h = h * flagRect.w / w;
            } else {
                flagRect.h = SCREEN_HEIGHT * 0.3;
